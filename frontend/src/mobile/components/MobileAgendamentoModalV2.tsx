...
const MobileAgendamentoModalV2: React.FC<Props> = ({
  isOpen,
  onClose,
  onSave,
  servicos,
  ...
  useEffect(() => {
    if (isOpen) {
      console.log('Modal aberto - Servicos:', servicos.length, 'Clientes:', clientes.length)
      const hoje = new Date()
      setClienteId('')
      setServicoId('')
...
export default MobileAgendamentoModalV2
